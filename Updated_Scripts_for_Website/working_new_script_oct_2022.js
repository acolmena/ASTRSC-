...
jQuery(document).ready(function ($) {
  ...
  function enterQuotes(voiceObj) {
    ...
    let h3tags = [
      "<h3><b>Breakdown of Speakers' Total Number of Words</b></h3>",
      "<h3><b>Breakdown of Speaker's Total Number of Quotes</b></h3>",
    ];
    ...
    if (!document.querySelector("h3")) {
      ...
      $("#wordNumChart").before(h3tags[0]);
      $("#quoteNumChart").before(h3tags[1]);
    }
